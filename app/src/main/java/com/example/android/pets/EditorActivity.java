...
public class EditorActivity extends AppCompatActivity {
    ...
    private void insertPet(){
        ...
        cv.put(PetEntry.COLUMN_PET_WEIGHT, weightString);

        PetDbHelper dbHelper = new PetDbHelper(this);
        SQLiteDatabase db = dbHelper.getWritableDatabase();

        long petId = db.insert(PetContract.PetEntry.TABLE_NAME,null,  cv);
        if (petId == -1) {
            Toast.makeText(this, "Error in saving pet " + petId, Toast.LENGTH_SHORT).show();
